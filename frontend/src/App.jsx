...
function App() {
  ...
  useEffect(() => {
    ...
    // Safety fallback: if intro hangs, force show content after 5 seconds
    ...
    <div className="min-h-screen bg-[#0B0B0D] text-white selection:bg-[#C8A97E]/30 overflow-x-hidden relative">
      ...
      {!showIntro && (
        <div className="relative z-10">
          <Navbar />
          <main>
            <section id="hero" className="bg-[#0B0B0D] relative overflow-hidden">
            ...
            <section id="about" className="bg-[#111113] relative border-t border-white/[0.02]">
            ...
            <section id="projects" className="bg-[#0B0B0D] relative border-t border-white/[0.02]">
            ...
            <section id="tech" className="bg-[#111113] relative border-t border-white/[0.02]">
            ...
            <section id="certificates" className="bg-[#1A1A1D] relative border-t border-white/[0.02]">
            ...
            <section id="coding" className="bg-[#111113] relative border-t border-white/[0.02]">
            ...
            <section id="education" className="bg-[#0B0B0D] relative border-t border-white/[0.02]">
            ...
            <section id="contact" className="bg-gradient-to-b from-[#111113] to-[#0B0B0D] relative border-t border-white/[0.02]">
