      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter text-slate-900 dark:text-white leading-tight mb-4">
            Certificates<span className="text-[#D4A373]">.</span>
          </h2>
      ...
      >
        ...
        <div className="card-content flex flex-col h-full">
          <div className="flex items-start justify-between mb-4">
             <div className="p-3 rounded-2xl bg-[#D4A373]/10 border border-[#D4A373]/20 group-hover:border-[#D4A373]/40 transition-colors">
             ...
             <div className="p-2 rounded-full bg-white/5 opacity-0 group-hover:opacity-100 transition-opacity">
               <ZoomIn size={18} className="text-[#D4A373]" />
             </div>
          </div>

          <h3 className="font-bold text-white mb-2 leading-tight group-hover:text-[#D4A373] transition-colors text-lg line-clamp-2">
            {cert.title}
          </h3>
          ...
          <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
            <span className="flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest">
              <Calendar size={12} className="text-[#D4A373]/50" />
              {cert.date}
            </span>
            <Eye size={16} className="text-[#D4A373]/0 group-hover:text-[#D4A373] transition-all" />
          </div>
        </div>
      </motion.div>
    ...
    >
      ...
      >
        ...
        <div className="modal-bottom-details">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#D4A373]/10 border border-[#D4A373]/20 text-[#D4A373] text-[10px] font-bold tracking-widest uppercase">
            <Award size={14} />
          ...
          <div className="flex items-center gap-4 text-slate-400">
             <span className="text-[#D4A373] font-bold">{cert.issuer}</span>
          ...
          <a 
            ...
            target="_blank" 
            rel="noreferrer"
            className="w-full max-w-sm mt-4 bg-[#D4A373] hover:bg-[#D4A373]/90 text-[#0B0B0C] font-black py-4 rounded-2xl flex items-center justify-center gap-3 transition-all group"
          >
            VERIFY CREDENTIALS
