...
const RESUME_TYPES = [
  ...
  },
  {
    ...
    filename: 'Specialized_Resume.pdf',
    icon: Zap,
    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-5xl bg-[#0a0a0b]/80 border border-white/10 rounded-[3rem] overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.8)] flex flex-col md:flex-row h-[90vh] md:h-auto md:min-h-[640px] group/hub"
        >
          {/* Animated Gradient Border Overlay */}
          <div className="absolute inset-0 pointer-events-none opacity-20 bg-gradient-to-tr from-blue-500/20 via-transparent to-indigo-500/20" />
          {/* Close Button */}
          <button
            onClick={onClose}
          ...
          {/* Left Side: Selection */}
          <div className="w-full md:w-[350px] p-10 border-r border-white/5 bg-[#0a0a0b]/40 backdrop-blur-3xl flex flex-col relative z-20">
            <motion.div 
                  ...
                  <div className="relative z-10 flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <div className={`w-1 h-1 rounded-full ${selectedType.id === type.id ? 'bg-blue-400' : 'bg-gray-800'}`} />
              ...
              >
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-5">
                    <motion.a
                      href={`/${selectedType.filename}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      whileHover={{ scale: 1.05, y: -2 }}
                      whileTap={{ scale: 0.98 }}
                      className="px-10 py-5 rounded-xl bg-blue-600 text-white font-black text-[11px] uppercase tracking-[0.3em] shadow-[0_20px_40px_-10px_rgba(37,99,235,0.4)] hover:bg-blue-500 transition-all duration-300 flex items-center justify-center gap-3"
                    >
                    ...
                    <motion.a
                      href={`/${selectedType.filename}`}
                      download={selectedType.filename}
                      ...
                      >
                         <div className="p-6 h-full flex flex-col">
                            ...
                            <div className="mt-6 flex gap-2">
                               <div className="w-8 h-8 rounded bg-blue-500/10" />
